...
def cloneNode(update,context):
    ...
    if len(args) > 1:
        link = args[1]
        msg = sendMessage(f"<b>⛽Cʟᴏɴɪɴɢ...</b>: <code>{link}</code>",context.bot,update)
        ...
        sendMessage("<b>🗼Pʟᴇᴀsᴇ Sᴇɴᴅ G-Dʀɪᴠᴇ ♻️Sʜᴀʀᴇᴀʙʟᴇ Fᴏʟᴅᴇʀ ID ᴏʀ Lɪɴᴋ Tᴏ Cʟᴏɴᴇ</b>.",context.bot,update)
